...
PROBES = [
    ...
    # expect 316 = 2026-08-19 #3 执行 F1-E-6 第六批 skill_icon_map/T-004（286 + 30：§7 T-004 17 + §8 skill_icon 13，元数据同步）
    ("day31_presentation_check", ["--script", "res://tools/day31_presentation_check.gd"], 316),
