...
CHARS = {
    "noah": ("F", "human",
             ...
             "vintage victorian outfit, white collared shirt, blue vest with gold trims, bowtie, "
             "long open-front vest with tailcoat-style back panels, "
             "open vest revealing white shirt and striped long trousers, "
             "vest back panels draping like a skirt, no skirt, "
             "long striped pants, not shorts, not bare legs, not a coat, "
             "puffy sleeves, high heel boots, "
             "vintage round brass goggles with rivets and leather strap, "
             "pocket watch chain, blue gold white color scheme"),
}

NEG = ("coat, jacket, outerwear, trench coat, open coat, long coat, shorts, short pants, hotpants, "
