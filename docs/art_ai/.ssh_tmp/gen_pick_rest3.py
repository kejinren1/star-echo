...
CHARS = {
    "b01": ("F", "human",
             ...
             "armored bodysuit with visible metal armor plates, battle armor, "
             "armored battle suit, revealing top with cutout, "
    ...
    "b04": ("M", "human",
             "1boy, adolescent to young adult male, slim lean athletic build, "
             "average build, eight head tall, "
             "white hair, sharp blue eyes, warm tan skin tone, handsome youthful face, "
    ...
    "b06": ("B", "stand",
             "minotaur warrior, bull head, huge curved horns, "
             "standing upright on two legs, upright posture, "
             "muscular strong body, leather armor with fur, "
             "wielding heavy battle axe, "
             "dark brown bronze color scheme"),
    "b07": ("F", "human",
             "1girl, tall slender goddess, very long black hair, pale skin, "
             "black sleeveless dress, bare shoulders, no horns, "
