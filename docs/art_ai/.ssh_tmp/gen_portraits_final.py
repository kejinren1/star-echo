...
CHARS = {
    ...
    "noah": ("F", "human",
             "1girl, young adult woman, tall slender figure, elegant long legs, eight head tall, "
             "silver blue short hair, blue eyes, "
             "vintage victorian outfit, white collared shirt, brown vest, bowtie, "
             "striped trousers, puffy sleeves, high heel boots, "
             "vintage round brass goggles with rivets and leather strap, "
             "pocket watch chain, dark blue brass white color scheme"),
    "lain": ("M", "human",
             "1boy, young adult male warrior, tall masculine body, eight head tall, broad shoulders, "
             "handsome youthful face, white hair, sharp blue eyes, "
             "full plate armor, breastplate, gauntlets, pauldrons, "
             "dual wielding longswords, silver gray steel color scheme"),
    "siia": ("F", "human",
             "1girl, young adult woman, tall slender figure, elegant long legs, eight head tall, "
             "soft long blonde hair, gentle green eyes, "
             "platinum white priestess dress, white dress with light trims, "
             "healing staff, delicate jewelry, white gold green color scheme"),
    "b01": ("F", "human",
             "1girl, dark skin, muscular toned female warrior, tall body, "
             "tight leotard battle suit, armored accents, boots, curved scimitar, "
             "black red silver color scheme"),
    "b02": ("M", "human",
             "1boy, extremely emaciated skeletal thin male mage, tall gaunt body, "
             "sunken hollow eyes, black sclera red eyes, white long hair, haggard face, "
             "tattered black robe, holding a large scythe, "
             "dark purple black color scheme"),
    "b03": ("M", "human",
             "1boy, gang leader, tall masculine body, "
             "ornate wild fur coat, gold chains, confident smug smirk, "
             "flamboyant boss attire, dark red gold black color scheme"),
    "b04": ("M", "human",
             "1boy, young adult male knight, tall body, broad shoulders, bare head, "
             "visible noble face, white armor main color, blue and gold trims, "
             "intricate fine armor engraving, breastplate, pauldrons, gauntlets, holy sword, "
             "righteous protagonist of light, white blue gold color scheme"),
    "b05": ("B", "animal",
             "feral wolf beast, pure quadrupedal animal, all fours, "
             "purple black fur, emaciated skeletal thin body, visible ribs, "
             "crimson red eyes, long prominent tail, "
             "ferocious snarling, bared fangs"),
    "b06": ("B", "animal",
             "minotaur warrior, huge curved horns, bull head, muscular, "
             "leather armor with fur, wielding heavy battle axe, "
             "dark brown bronze color scheme"),
    "b07": ("F", "human",
             "1girl, tall slender goddess, very long black hair, pale skin, "
             "black sleeveless dress, bare shoulders, elegant horns, "
