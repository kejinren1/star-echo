#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""gen_v14_batch.py — v14 狼重绘×4：病态消瘦（emaciated 瘦骨嶙峋）"""
...
NEG = ("blurry, low quality, ugly, deformed, broken anatomy, twisted limbs, wrong leg joints, "
...
WOLF = ("feral wolf beast, pure quadrupedal animal form, natural wolf anatomy, not anthropomorphic, "
        "sickly emaciated body, skeletal thin, malnourished, starving, visible ribs, "
        "sunken flanks, protruding spine, gaunt hollow frame, "
        "purple-black fur color scheme, elongated slender legs, "
        "long prominent twisted tail raised, blood-red eyes, ferocious snarling expression, "
...
def main():
    ...
    seed = 20261421
    for k in range(4):
        tasks.append((f"v14_wolf_{k+1}", WOLF, seed + k))
